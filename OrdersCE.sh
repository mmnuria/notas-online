...
curl -X POST 'http://localhost:9090/CentroEducativo/alumnos/12345678W/asignaturas?key='$KEY2 -H  "accept: text/plain" -H  "Content-Type: application/json" -d "DEW" -c cucu -b cucu
