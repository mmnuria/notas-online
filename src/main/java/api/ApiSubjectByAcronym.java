...
@WebServlet("/API/SubjectByAcronym")
public class ApiSubjectByAcronym extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.isUserInRole("rolalu")) {
			...
			String acronimo = request.getParameter("subject");

			try {
				String url = null;
				// Prepare the request parameters
				url = DatabaseConfig.CENTRO_EDUCATIVO_URL + "/asignaturas/" + acronimo + "?key=" + key;
